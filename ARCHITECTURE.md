...
| 8081 | TLS (internal) | Gateway control plane, HMAC-authenticated, RFC-1918 only, never published to host |
...
- Control plane: HMAC-authenticated, restricted to RFC-1918 ranges, not published to the host
